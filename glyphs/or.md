...
within relative error `1e-14` of that ratio. Integer convergents are
computed exactly. The result is the larger magnitude divided by the
convergent’s numerator. Exact inputs use exact GCD. Complex inputs use
