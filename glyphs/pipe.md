...
`Y→f→g` passes Y through f, then g. Each stage uses ordinary APL
binding.
...
Stages receive one right argument. A left section, such as `10-`, binds
a dyad’s left argument. [After](after.qmd) binds its right argument. A
dfn also works.
