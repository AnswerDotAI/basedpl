...
`P⊃Y` selects leading-axis coordinates. Remaining axes form a cell; full
coordinates return the stored value. Successive Picks traverse nesting.
Empty coordinates return `Y`.
