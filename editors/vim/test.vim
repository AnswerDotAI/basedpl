...
call setline(1, ["⍝ comment + 'text'", "'can''t ⍝ +' ⋄ ⍳3", '+/1 2', "'unfinished", '⍪⍛⌺⍠\\⇄⌾↕ℙ⨸⊛∂⌝•⍶⍹'])
call assert_equal('apl', &filetype)
for [lnum, pattern, group] in [
      \ [1, '+', 'aplComment'], [1, 'text', 'aplComment'], [2, '⍝', 'aplString'], [2, '+', 'aplString'],
      \ [2, '⍳', 'aplGlyph'], [3, '/', 'aplGlyph'], [5, '⍛', 'aplGlyph'], [5, '\\', 'aplGlyph'], [5, '⊛', 'aplGlyph'], [5, '⌝', 'aplGlyph'], [5, '•', 'aplGlyph'], [5, '⍶', 'aplGlyph'], [5, '⍹', 'aplGlyph']]
