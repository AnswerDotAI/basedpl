...
_vocabulary = [
    ...
    ('*', 'exponential', 'power'), ('⍟', 'logarithm', 'log'), ('○', 'pi_times', 'circle'), ('!', 'factorial', 'binomial'),
    ('|', 'magnitude', 'residue'), ('⌊', 'floor', 'min'), ('⌈', 'ceiling', 'max'),
    ('∧', None, 'lcm'), ('∨', None, 'gcd'), ('⍲', None, 'nand'), ('⍱', None, 'nor'), ('~', 'not_', 'without'),
    ('=', None, 'equal'), ('≠', 'unique_mask', 'not_equal'), ('<', None, 'less'), ('≤', None, 'less_equal'),
    ('>', None, 'greater'), ('≥', None, 'greater_equal'), ('≡', 'depth', 'match'), ('≢', 'tally', 'not_match'),
    ...
    ('⌷', 'materialise', 'index'), ('⊤', None, 'encode'), ('⊥', None, 'decode'), ('⌹', 'inverse', 'matrix_divide'),
