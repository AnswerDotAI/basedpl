...
Docs: https://answerdotai.github.io/basedpl/dyalog.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/dyalog.ipynb.

# %% auto #0
__all__ = ['find_dyalog', 'start_dyalog', 'ride_send', 'ride_recv', 'AplError', 'AplPrompt', 'ride_run', 'Apl']

# %% ../../nbs/dyalog.ipynb #fb7b388f
import atexit, json, socket, subprocess
from shutil import which
from fastcore.utils import *
from .notebooks import AplOut

# %% ../../nbs/dyalog.ipynb #e92f710a
def find_dyalog():
...
def run(self:Apl, code):
    ...
    try: out,err = ride_run(self.sock, code)
        ...
        if e.ptype in (2,4):
            ...
            raise AplError('Input via ⎕ or ⍞ is not supported in basedpl.dyalog') from None
        self.close()
        self._connect()
